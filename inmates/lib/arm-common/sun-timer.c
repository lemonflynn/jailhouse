...
static int sun_timer_scheduler(unsigned int ms, struct sun_timer * timer_in);
...
int sun_timer_scheduler(unsigned int ms, struct sun_timer * timer_in)
{
    struct sun_timer * timer, * next_timer = event_queue;
    unsigned int raw_time = 0, delta = 0;
